...
#Load 
df <- read.csv("SDC_Rouse_Mean.csv")
...
ggplot(df, aes(x=Rouse_adj, fill=Flow.Type)) + 
  ...
  labs(title="SDC Rouse Numbers: Mean MaTCH Density Distributions",
       x="Rouse Numbers",
       y="Density") +
  theme_minimal()
...
df_10 <- read.csv("SDC_Rouse_10th.csv")
...
ggplot(df_10, aes(x=Rouse_adj, fill=Flow.Type)) + 
  ...
  geom_vline(xintercept = c(-1.8, -0.6), linetype = "dashed", color = "gray") +
  scale_x_continuous(limits = c(-5, 7.5), breaks = seq(-5, 7.5, by = 2.5)) +  # Set x-axis limits and breaks +
  labs(title="SDC Rouse Numbers: 10th percentile MaTCH Density Distributions",
       x="Rouse Numbers",
       y="Density") +
  theme_minimal()
...
df_90 <- read.csv("SDC_Rouse_90th.csv")
...
ggplot(df_90, aes(x=Rouse_adj, fill=Flow.Type)) + 
  ...
  geom_vline(xintercept = c(-1.8, -0.6), linetype = "dashed", color = "gray") +
  scale_x_continuous(limits = c(-5, 7.5), breaks = seq(-5, 7.5, by = 2.5)) +  # Set x-axis limits and breaks +
  labs(title="SDC Rouse Numbers: 90th percentile MaTCH Density Distributions",
       x="Rouse Numbers",
       y="Density") +
  theme_minimal()
...
#Load 
df_sum <- read.csv("SDC_Rouse_FTIR_short_summary.csv")
df_sum <- df_sum %>% 
...
ggplot(df_long, aes(x=Rouse_adj_value, fill=Scenario)) + 
  ...
  labs(title="SDC Rouse Numbers: μFTIR subset",
       x="Rouse Numbers",
       y="Density (%)") +
  theme_minimal() +
...
custom_labels <- c(
  "Low Flow" = "Low Flow (n = 204)",
  "Stormflow" = "Stormflow (n = 411)"
)
...
ggplot() + 
  ...
  labs(title="SDC Rouse Numbers: μFTIR subset (Non-Fibers only)",
       x="Rouse Numbers",
       y="Density (%)") +
  ...
  geom_text(data = df_percent_Cowger, aes(x = 6, y=1.5, label = paste0("% Washload","\nMean: ", round(Percent_Mean_Wash, 2), "%\n10th: ", round(Percent_10_Wash, 2), "%\n90th: ", round(Percent_90_Wash, 2), "%")), size = 4.5, hjust = 0.5) +
  geom_label(data = df_percent_Cowger, aes(x = 0, y = 4.3, label = "Wash load"), size = 3, color = "black", fill = "white", fontface = "bold") +
  geom_label(data = df_percent_Cowger, aes(x = 1.65, y = 4.0, label = "Settling \nSuspended \nLoad"), size = 3, color = "black", fill = "white", fontface = "bold") +
  geom_label(data = df_percent_Cowger, aes(x = -1.65, y = 4, label = "Rising \nSuspended \nLoad"), size = 3, color = "black", fill = "white", fontface = "bold") +
  geom_label(data = df_percent_Cowger, aes(x = -3.75, y = 4.3, label = "Surface Load"), size = 3, color = "black", fill = "white", fontface = "bold") +
  geom_label(data = df_percent_Cowger, aes(x = 5, y = 4.3, label = "Bed Load"), size = 3, color = "black", fill = "white", fontface = "bold") 
...
custom_labels <- c(
  "Inside Thalweg" = "Thalweg (n=130)",
  "Outside Thalweg_1" = "Nearest Right Bank (n=108)"
)
...
ggplot() + 
  ...
  labs(title="SDC Rouse Numbers: Stormflow μFTIR subset (Non-Fibers only)",
       x="Rouse Numbers",
       y="Density") +
  theme_minimal() +
  theme(
  ...
  theme(legend.position="bottom") +
  scale_fill_manual(name = "Particle Density (MaTCH) Assigned", values = c("Mean" = "blue", "10th Percentile" = "red", "90th Percentile" = "green")) +
  geom_text(data = df_percent_Cowger, aes(x = 6, y=2.0, label = paste0("% Washload","\nMean: ", round(Percent_Mean_Wash, 2), "%\n10th: ", round(Percent_10_Wash, 2), "%\n90th: ", round(Percent_90_Wash, 2), "%")), size = 4.5, hjust = 0.5) +
geom_label(data = df_percent_Cowger, aes(x = 0, y = 5.9, label = "Wash load"), size = 3, color = "black", fill = "white", fontface = "bold") +
  geom_label(data = df_percent_Cowger, aes(x = 1.65, y = 5.5, label = "Settling \nSuspended \nLoad"), size = 3, color = "black", fill = "white", fontface = "bold") +
  geom_label(data = df_percent_Cowger, aes(x = -1.65, y = 5.5, label = "Rising \nSuspended \nLoad"), size = 3, color = "black", fill = "white", fontface = "bold") +
  geom_label(data = df_percent_Cowger, aes(x = -3.75, y = 5.9, label = "Surface Load"), size = 3, color = "black", fill = "white", fontface = "bold") +
  geom_label(data = df_percent_Cowger, aes(x = 5, y = 5.9, label = "Bed Load"), size = 3, color = "black", fill = "white", fontface = "bold") 
###################################
