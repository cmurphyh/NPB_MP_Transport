...
#Load 
df <- read.csv("SDC_Rouse_TRWP_Mean.csv")
...
df_10 <- read.csv("SDC_Rouse_TRWP_10th.csv")
...
df_90 <- read.csv("SDC_Rouse_TRWP_90th.csv")
...
#Load 
df_sum <- read.csv("SDC_Rouse_TRWP_short_summary.csv")
df_sum <- df_sum %>% 
...
ggplot(df_long, aes(x=Rouse_adj_value, fill=Scenario)) + 
  ...
  labs(title="SDC Rouse Numbers: Suspected TRWPs",
       x="Rouse Numbers",
       y="Density (%)") +
  theme_minimal() +
...
custom_labels <- c(
  "Low Flow" = "Low Flow (n = 157 )",
  "Stormflow" = "Stormflow (n = 674)"
)
...
ggplot() + 
  ...
  geom_label(data = df_percent_Cowger, aes(x = 0, y = 3.3, label = "Wash load"), size = 3, color = "black", fill = "white", fontface = "bold") +
  geom_label(data = df_percent_Cowger, aes(x = 1.65, y = 3.0, label = "Settling \nSuspended \nLoad"), size = 3, color = "black", fill = "white", fontface = "bold") +
  geom_label(data = df_percent_Cowger, aes(x = -1.65, y = 3, label = "Rising \nSuspended \nLoad"), size = 3, color = "black", fill = "white", fontface = "bold") +
  geom_label(data = df_percent_Cowger, aes(x = -3.75, y = 3.3, label = "Surface Load"), size = 3, color = "black", fill = "white", fontface = "bold") +
  geom_label(data = df_percent_Cowger, aes(x = 5, y = 3.3, label = "Bed Load"), size = 3, color = "black", fill = "white", fontface = "bold") 
...
custom_labels <- c(
  "Inside Thalweg" = "Thalweg (n=305)",
  "Outside Thalweg_1" = "Nearest Right Bank (n=72)"
)
...
ggplot() + 
  ...
  scale_x_continuous(limits = c(-5, 7.5), breaks = seq(-5, 7.5, by = 2.5)) +
  scale_y_continuous(limits=c(0,3),breaks = seq(0, 3.0, by = 0.5))+
  labs(title="SDC Rouse Numbers: Stormflow Suspected TRWPs",
       x="Rouse Numbers",
       y="Density (%)") +
  theme_minimal() +
  theme(
  ...
  scale_fill_manual(name = "Particle Density (MaTCH) Assigned", values = c("Mean" = "blue", "10th Percentile" = "red", "90th Percentile" = "green")) +
  geom_text(data = df_percent_Cowger, aes(x = 6, y=1.5, label = paste0("% Washload","\nMean: ", round(Percent_Mean_Wash, 2), "%\n10th: ", round(Percent_10_Wash, 2), "%\n90th: ", round(Percent_90_Wash, 2), "%")), size = 4.5, hjust = 0.5) +
geom_label(data = df_percent_Cowger, aes(x = 0, y = 3.0, label = "Wash load"), size = 3, color = "black", fill = "white", fontface = "bold") +
  geom_label(data = df_percent_Cowger, aes(x = 1.65, y = 2.7, label = "Settling \nSuspended \nLoad"), size = 3, color = "black", fill = "white", fontface = "bold") +
  geom_label(data = df_percent_Cowger, aes(x = -1.65, y = 2.7, label = "Rising \nSuspended \nLoad"), size = 3, color = "black", fill = "white", fontface = "bold") +
  geom_label(data = df_percent_Cowger, aes(x = -3.75, y = 3.0, label = "Surface Load"), size = 3, color = "black", fill = "white", fontface = "bold") +
  geom_label(data = df_percent_Cowger, aes(x = 5, y = 3.0, label = "Bed Load"), size = 3, color = "black", fill = "white", fontface = "bold") 
###################################
