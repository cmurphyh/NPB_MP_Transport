...
custom_labels <- c(
  "Low Flow" = "Low Flow (n = 159)",
  "Stormflow" = "Stormflow (n = 244)"
)
...
ggplot() + 
  ...
  labs(title="SAD Rouse Numbers: μFTIR subset (Non-Fibers only)",
       x="Rouse Numbers",
       y="Density (%)") +
...
custom_labels <- c(
  "Inside Thalweg" = "Thalweg (n=75)",
  "Outside Thalweg_1" = "Nearest Right Bank (n=90)",
  "Outside Thalweg_2" = "Nearest Left Bank (n=79)"
)
...
ggplot() + 
  ...
  labs(title="SAD Rouse Numbers: Stormflow μFTIR subset (Non-Fibers only)",
       x="Rouse Numbers",
       y="Density (%)") +
  theme_minimal() +
  theme(
