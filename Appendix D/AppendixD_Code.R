...
setwd("~/Desktop/Papers/Streamflow Composition Paper/Supplemental Materials/AppendixD/AppendixD_Plots_Datasets/Tables D2-D5")

#Load data into R

#SELECT INPUT FILE
data <- read.csv("TableD2.csv") #Table D2 μFTIR Confirmed “plastic” Dataset for SDC
#data <- read.csv("TableD3.csv") #Table D3 μFTIR Confirmed “plastic” Dataset for SAD
#data <- read.csv("TableD4.csv") #Table D4 Suspected TRWP Dataset for SDC
#data <- read.csv("TableD5.csv") #Table D5 Suspected TRWP Dataset for SAD
...
write.csv(data, "NAMEData_Settling.csv") #NAME FILE YOUR FILE
...
#Write results to file
write.csv(data, "NAMEData_Rouse.csv") #NAME FILE YOUR FILE
